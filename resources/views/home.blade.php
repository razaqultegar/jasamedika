    ...
    <div class="p-4">
        ...
        <div class="mt-4">
            <div class="grid grid-cols-2 gap-x-2 gap-y-6">
                ...
                @endif
                    <img src="{{ asset('medias/placeholder.jpeg') }}" alt="Bersama Peduli Menebar Cinta dan Kebaikan Islam" width="220" height="120" class="h-[120px] w-full rounded-tl-lg rounded-tr-lg">
                    <div class="p-3">
