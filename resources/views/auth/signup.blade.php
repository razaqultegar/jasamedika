...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-bs-theme="light">
    ...
    <body class="text-base">
        ...
        <div class="max-w-480 relative mx-auto bg-white w-full" style="top: 60px; height: calc(-60px + 100vh);">
            <div class="px-8 py-6">
                <div>
                    <h3 class="mb-4 text-lg font-semibold leading-normal">Petualangan Anda dimulai dari sini</h3>
                </div>
                <form action="{{ route('signup') }}" method="post">
                    ...
                    <div class="mb-3">
                        <button type="submit" class="text-center leading-normal cursor-pointer transition-all duration-300 ease-in focus:outline-none focus:text-current w-full align-middle py-2 px-4 rounded-md pointer-events-none cursor-not-allowed text-clrSubText bg-coal font-bold" disabled="">Daftar</button>
                    </div>
                </form>
                <div class="mt-5">
