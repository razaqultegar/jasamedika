            ...
            <div class="flex items-center justify-between px-[0.5em] py-[1em]">
                ...
                <label for="available">
                    <div class="checkbox-container">
                        <input type="checkbox" id="available" name="available" value="true" {{ request()->query('available') == 'true' ? 'checked' : '' }}>
                        <span>
...
<script type="text/javascript">
    document.getElementById('sortform').addEventListener('submit', function(event) {
        ...
        const available = this.elements['available'].checked ? 'true' : 'false';

        currentUrl.searchParams.set('available', available);
