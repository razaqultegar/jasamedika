...
<div class="mb-[56px]">
    ...
    <a href="#" style="color: rgb(74, 74, 74);">
        <div class="flex h-[75px] cursor-pointer items-center border-b-[0.5px] border-davy px-2 py-5">
            <img src="https://assets.kitabisa.cc/images/icons/icon__user_delete.svg" alt="Hapus Akun">
            <span class="mx-[1em] my-0 flex-[1] text-base leading-[19px]">Hapus Akun</span>
            <div class="m-0">
